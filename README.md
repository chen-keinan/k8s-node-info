[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/chen-keinan/kube-node-info/blob/main/LICENSE)

# kube-node-Info

Kube-Node-Info is an open source collector who collect Node information (fs and process data) and output in a table/json format.
...
node-info-ng2z7                          0/1     Completed   0          6m13s
```

* Check k8s pod audit output

```
kubectl logs node-info-ng2z7
```
